...
def get_genai_base_url():
    ...
    # Option 3: Final fallback (you can remove this if you want to force configuration)
    st.error("⚠️ GenAI API URL not configured. Please set GENAI_BASE_URL in secrets or environment.")
    st.stop()
